				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-mega mx-auto">
						...
						<li class="nav-item  active">
							<a class="nav-link" href="about_1.jsp">About</a>
						</li>
							...
							<ul class="dropdown-menu mega-menu ">
								<li>
									<div class="row">
										...
										<div class="col-md-4 media-list span4 text-left">
											<h5 class="tittle-w3layouts-sub">Postal Covers </h5>
											<div class="media-mini mt-3">
												<a href="shop.jsp">
				...
				<div class="about-content py-lg-5 py-3">
					<div class="row">
						...
						<div class="col-lg-6 p-0">
							<img src="images/banner1.jpg" alt="E-Post" class="img-fluid">
						</div>
						<div class="col-lg-6 about-info">
							<h3 class="tittle-w3layouts text-left mb-lg-5 mb-3">About Us</h3>
							<p class="my-xl-4 my-lg-3 my-md-4 my-3">We provide world class postal service.
                                                            We deliver product to customer on time and time which convenient to them
							</p>
					...
					<div class="row mt-lg-5 mt-3">
						<div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								<div class="team-img">
									<img class="img-fluid rounded" src="images/p11.jpg" alt="">
								</div>
								<div class="team-info">
									<h4>Partner 1</h4>
									<span>CEO</span>
					 ...
					 <div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								<div class="team-img">
									<img class="img-fluid rounded" src="images/p2.jpg" alt="">
								</div>
								<div class="team-info">
									<h4>Partner 2</h4>
									<span>President</span>
						...
						<div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								<div class="team-img">
									<img class="img-fluid rounded" src="images/p3.jpg" alt="">
								</div>
								<div class="team-info">
									<h4>Partner 3</h4>
						...
						<div class="col-md-3 team-main-gd">
							<div class="team-grid text-center">
								<div class="team-img">
									<img class="img-fluid rounded" src="images/p4.jpg" alt="">
								</div>
								<div class="team-info">
									<h4>Partner 4</h4>

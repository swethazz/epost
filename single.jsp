							...
							<div class="col-lg-4 single-right-left ">
								...
								<div class="col-lg-8 single-right-left simpleCart_shelfItem">
									...
									<div class="occasional">
										<h5>Types :</h5>
										<div class="colr ert">
											<label class="radio"><input type="radio" name="radio" checked=""><i></i> stamps india</label>
										</div>
										<div class="colr">
											<label class="radio"><input type="radio" name="radio"><i></i> stamps international</label>
										</div>
										<div class="colr">
											<label class="radio"><input type="radio" name="radio"><i></i> stamps for postal </label>
										</div>
										<div class="clearfix"> </div>
									</div>
